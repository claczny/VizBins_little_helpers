...
## Original name is fastaNamesSizes.pl and code taken from http://www.molecularevolution.org/molevolfiles/exercises/QC_of_NGS/fastaNamesSizes.pl

## Help text in perldoc format
=head1 SYNOPSIS

seq_stats.pl -	returns a tab list with name and size of sequences 
                in a fasta file on the standard output, and some stats
                on the standard error.

Original name: fastaNamesSizes.pl; taken from http://www.molecularevolution.org/molevolfiles/exercises/QC_of_NGS/fastaNamesSizes.pl

=head1 USAGE

seq_stats.pl [-f format] fasta_file
